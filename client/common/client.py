...
class Client:
    ...
    def run(self):
        ...
        try:
            ...
            self.send_dataset("/datasets/games-reducido.csv", client_socket, Dataset(Dataset.GAME))
            self.send_dataset("/datasets/reviews-reducido.csv", client_socket, Dataset(Dataset.REVIEW))

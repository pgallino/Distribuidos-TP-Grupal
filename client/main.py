...
def main():
    ...
    try:
        ...
        send_dataset("/datasets/games.csv", client_socket, 1, Dataset(Dataset.GAME), logger)
        send_dataset("/datasets/reviews.csv", client_socket, 1, Dataset(Dataset.REVIEW), logger)

...
def main():
    try:
        ...
        replica = PropagatorReplica(replica_id, container_name="propagator_replica", container_to_restart="propagator_1", n_replicas=config_params["propagator_replica_instances"])

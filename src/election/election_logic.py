...
def initiate_election(node_id, node_ids, ip_prefix, port, election_in_progress, condition, waiting_ok, ok_condition, leader_id):
    ...
    if not higher_node_ids:
        declare_leader(node_id, node_ids, ip_prefix, port, election_in_progress, condition, leader_id)
    ...
    _wait_for_ok_or_leader(node_id, node_ids, ip_prefix, port, election_in_progress, condition, waiting_ok, ok_condition, leader_id)


def _wait_for_ok_or_leader(node_id, node_ids, ip_prefix, port, election_in_progress, condition, waiting_ok, ok_condition, leader_id):
...
def declare_leader(node_id, node_ids, ip_prefix, port, election_in_progress, condition, leader_id):
    ...
    _notify_leader_selected(node_id, node_ids, ip_prefix, port, election_in_progress, condition, leader_id)


def _notify_leader_selected(node_id, node_ids, ip_prefix, port, election_in_progress, condition, leader_id):

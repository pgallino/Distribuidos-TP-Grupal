...
class Node:
    ...
    def _synchronize_with_replicas(self):
        ...
        self._middleware.receive_from_queue_with_timeout(self.recv_queue, on_response, 5, auto_ack=False)

        logging.info(f"Master {self.id}: Sincronización completada.")

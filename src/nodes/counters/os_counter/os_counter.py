...
class OsCounter(Node):
    ...
    def _process_message(self, ch, method, properties, raw_message):
        ...
        simulate_random_failure(self, log_with_location("CAIDA ANTES DE HACER EL ACK AL MENSAJE"), probability=0)
        # ==================================================================
        ...
        simulate_random_failure(self, log_with_location("CAIDA DESPUES DE HACER EL ACK AL MENSAJE"), probability=0)
        # ==================================================================
    ...
    def _process_game_message(self, msg):
        ...
        simulate_random_failure(self, log_with_location("CAIDA DESPUES DE ACTUALIZAR LOS CONTADORES Y ANTES DE ENVIAR A LA REPLICA"), probability=0)
        # ==================================================================
    ...
    def load_state(self, msg: PushDataMessage):
        ...
        simulate_random_failure(self, log_with_location("CAIDA ANTES DE CARGAR EL ESTADO"),probability=0)
        # ==================================================================
        ...
        simulate_random_failure(self, log_with_location("CAIDA DESPUES DE CARGAR EL ESTADO"), probability=0)
        # ==================================================================

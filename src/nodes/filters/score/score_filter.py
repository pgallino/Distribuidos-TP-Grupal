...
from utils.constants import E_COORD_SCORE, E_FROM_PROP, E_FROM_SCORE, E_FROM_TRIMMER, K_FIN, K_NEGATIVE, K_NEGATIVE_TEXT, K_NOTIFICATION, K_POSITIVE, K_REVIEW, Q_COORD_SCORE, Q_NOTIFICATION, Q_TO_PROP, Q_TRIMMER_SCORE_FILTER
...
class ScoreFilter(Node):
    def __init__(self, id: int, n_nodes: int, n_next_nodes: List[Tuple[str, int]], container_name):
        ...
        self._middleware.bind_queue(Q_TRIMMER_SCORE_FILTER, E_FROM_PROP, key=K_FIN+f'_{container_name}')
